...
export default function ContactSection() {
  ...
  const contactItems = [
    { icon: "✉", label: "arnavranjan50@gmail.com", href: "mailto:arnavranjan50@gmail.com" },
    { icon: "☎", label: "+91 8446548117", href: "tel:+918446548117" },
    { icon: "📍", label: "Bengaluru, India", href: "#" },
  ];
  ...
  return (
    <section id="contact" className="relative bg-[#1c1c1c] py-32">
      <div className="mx-auto max-w-[700px] px-6 text-center">
        <div ref={headingRef}>
          ...
          >
            ...
            craft? I&apos;d love to hear from you.
          </motion.p>
        </div>

        {/* Contact pills */}
        <div ref={linksRef} className="mb-12 flex flex-col items-center gap-4">
          {contactItems.map((item, i) => (
            <motion.a
              key={item.label}
              href={item.href}
              initial={{ y: 30, opacity: 0 }}
              animate={linksVisible ? { y: 0, opacity: 1 } : {}}
              transition={{
                duration: 0.6,
                delay: i * 0.1,
                ease: "easeOut",
